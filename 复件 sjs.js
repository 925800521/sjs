...
;(function(W,undefined){
	var D=W.document,
		...
		//sjs对象整合到documentFragment对象中并返回
		function stodf(o){
		...
		var SET={
	 	...
	 	initswipe=function(){
			...
			document.body.addEventListener(SET['vmouseup'],endtouch,false);
			document.body.addEventListener(SET['vmouseout'],endtouch,false);
			document.body.addEventListener(SET['vmousecancel'],endtouch,false);
		},
		EVENTS={
			on:function(){
